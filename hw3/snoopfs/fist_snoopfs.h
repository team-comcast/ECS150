 ...
 */
#ifndef _fist_snoopfs_h
#define _fist_snoopfs_h
...
/* MACROS AND STRUCTURES BASED ON FIST FILE ./tests/snoopfs.fist */

/* Name of the file system? */
#define FIST_FSNAME "snoopfs"
